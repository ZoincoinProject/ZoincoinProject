...
void ThreadMapPort2(void* parg)
{
    ...
    if (r == 1)
    {
        ...
        string strDesc = "ZoinCoin " + FormatFullVersion();
#ifndef UPNPDISCOVER_SUCCESS
        /* miniupnpc 1.5 */
...
static const char *strDNSSeed[][2] = {
    {"207.154.239.123", "207.154.239.123"},
    {"146.185.163.198", "146.185.163.198"},
    {"138.197.152.109", "138.197.152.109"},
    {"192.241.252.83", "192.241.252.83"},
    {"146.185.138.12", "146.185.138.12"},
    {"192.241.212.133", "192.241.212.133"},
    {"138.68.158.98", "138.68.158.98"},
...
bool BindListenPort(const CService &addrBind, string& strError)
{
    ...
    if (::bind(hListenSocket, (struct sockaddr*)&sockaddr, len) == SOCKET_ERROR)
    {
        ...
        if (nErr == WSAEADDRINUSE)
            strError = strprintf(_("Unable to bind to %s on this computer. ZoinCoin is probably already running."), addrBind.ToString().c_str());
        else
